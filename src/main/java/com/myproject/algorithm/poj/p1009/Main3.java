package com.myproject.algorithm.poj.p1009;
...
public class Main3 {
    ...
    private static List<int[]> outList = new ArrayList<int[]>();

    private static int[] lastNode = null;
    ...
    private static void showOutData() {
        for (int[] node : outList) {
            System.out.println(new StringBuilder().append(node[0]).append(" ").append(node[1]));
        }
    }
